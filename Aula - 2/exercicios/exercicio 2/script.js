...
document.body.style.font = "Arial, sans-serif";
  ...
  const Nome = document.getElementById('nickname').innerText = 'Jemima Matheus';
  const Favorito = document.getElementById('favoritos').innerText = 'Gosto de arranhar no piano, ler, comer e dormir';
  const Cidade = document.getElementById('cidade').innerText = 'São Paulo - ZL';
